...
public class CnToSpell {
	 ...
	 * 否则到SpellMap中查找,如果没有找到拼音,则返回null,如果找到则返回拼音.
	 */
	public static String getSpellByAscii2(String ascii) {
		if (ascii.indexOf("-") > -1)
		{
			String result = (String)spellMap.get(ascii);
	 ...
	 */
	public static String getFullSpell2(String cnStr)
	{
		...
		for (int i = 0, Len = chars.length; i < Len; i++) {
			...
			if (ascii.length() == 0) { // 取ascii时出错
				...
				String spell = getSpellByAscii2(ascii);
				if (spell == null) {
					retuBuf.append(chars[i]);
				} else {
